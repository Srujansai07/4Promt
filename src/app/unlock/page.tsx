...
- Any missing improvements or enhancements

OUTPUT FORMAT:
1. Summary (What is this product?)
2. Core Features (Must-have features)
3. User Interaction Flow (How users will use it)
...
3. FEATURE LIST (MVP + Future enhancements)
4. SCREEN / PAGE MAP (All pages needed)
5. FUNCTIONAL REQUIREMENTS (What it must do)
6. NON-FUNCTIONAL REQUIREMENTS (Speed, UX, security, accessibility)
7. DATA STRUCTURE (JSON format)
8. API ENDPOINT PLAN (All backend routes)
...
---CONCEPT---
Explain the idea in detail. What problem does it solve? Who is it for?

---OBJECTIVES---
List primary, secondary, and tertiary goals.

---FEATURES---
Numbered features with clear purpose for each.

---DATA MODEL (JSON)---
Provide clean database schema.

---LOGIC FLOW---
Describe how the system works step-by-step.

---IMPLEMENTATION PLAN---
List all tasks with substeps.
...
5. API Blueprint
6. UI/UX Layout (textual wireframes, not visual)
7. Tasks & Milestones
...
4. FEATURE SPECIFICATIONS
   - Each feature with acceptance criteria
...
8. WORKFLOWS
   - User flows (diagrams in text)
   - System flows (backend processes)
...
13. FINAL HANDOFF PACKAGE
    - List of all files the automated builder must generate
    - Folder structure
